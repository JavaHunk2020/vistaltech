   ...
   <form action="updateSignup" method="post">
     <div style="width: 50%">
	   ...
	   <input required="required" type="text" class="form-control" name="firstName" value="${employee.firstName}"/> 
	      <h5>LastName :</h5>
	   <input required="required" type="text" class="form-control" name="lastName" value="${employee.lastName}"/> 
	    <h5>Password :</h5>
	   <input required="required" type="password" class="form-control"  name="password" value="${employee.password}"/> 
	    <h5>Email :</h5>
